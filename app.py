...
import pickle
import pandas as pd
st.title("The Swiggy Delivery Time Prediction🚴‍♀")
df = pd.read_csv(r"C:\Users\Sravani\Downloads\swiggy_cleaned.csv")
...
is_weekend =  st.number_input('Is it Weekend:',min_value=0,max_value=1)
...
with open(r"C:\Users\Sravani\Downloads\model (1).pkl",'rb') as file:
